// Типы событий (используем тот же енум что и у инцидентов)
...
// Категории событий для ИБ
export enum EventCategoryInformationEnum {
...
// Категории событий для БПиО
export enum EventCategorySecurityEnum {
